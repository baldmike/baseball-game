...
An interactive baseball game that uses real MLB rosters and player stats. Pick any team and season from 1920–2025, choose your starting pitcher, pick an opponent from any era, then play a full 9-inning game or simulate it with animated play-by-play.

## Tech Stack

- **Frontend:** Vue 3 / Vite (pure SPA — all game logic runs in the browser)
...
### Gameplay
- **Play mode** — you pitch when your team is in the field (fastball, curveball, slider, changeup) and bat when they're up (swing, bunt, or take)
